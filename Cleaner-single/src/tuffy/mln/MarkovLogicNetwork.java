...
//		clone.mapConstantID = (HashMap<String, Integer>) mapConstantID.clone();
	 ...
	 * @throws IOException 
	 */
	public void loadPrograms(String[] progFiles) throws IOException{
	 ...
	 * @throws IOException 
	 */
	public void loadEvidences(String[] evidFiles) throws IOException{
	 ...
	 * @throws IOException 
	 */
	public void loadQueries(String[] queryFiles) throws IOException{
	 ...
	 */
	public void materializeTables() throws IOException{
